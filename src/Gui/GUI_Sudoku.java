...
public class GUI_Sudoku extends JFrame {
	 ...
	 * @param num_boton Numero del boton presionado.
	 * @param celda_presionada Ultima celda presionada.
	 * @param lbl_mensaje Label a setear la imagen.
	 */
	 ...
	 * 
	 * @param es Estado de habilitacion.
	 */
	...
	/**
	 * Adapta el tamaño de la imagen al tamaño del boton.
	 * 
	 * @param boton Boton a adaptar el tamaño de su imagen.
	 ...
	 * 
	 * @param label Label a adaptar el tamaño de su imagen.
	 * @param grafico Imagen a redimensionar.
	 */
